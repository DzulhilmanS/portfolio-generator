 ...
 *
 * Fundamentals note:
 *   Railway datacenter IPs are blocked by Yahoo Finance for fundamentals endpoints.
 *   fetchFundamentals returns empty nulls silently — scoring uses technical + risk-reward only.
 */
 ...
 *
 * NOTE: Railway datacenter IPs are blocked by Yahoo Finance for all fundamentals
 * endpoints (v7, v10). Returns empty nulls silently — no error logs.
 * Scoring engine handles nulls and falls back to technical + risk-reward only.
 */
